...
public class MainController {
	...
	public String query1() {
		User1VO user = repo.findUser1VOByUid("a201");
		System.out.println("query1 결과 : "+user);
		return "redirect:/";
	}
	@GetMapping("/query2")
	public String query2() {
		List<User1VO> users = repo.findUser1VOByName("홍길동");
	...
	public String query4() {
		List<User1VO> users = repo.findUser1VOByUidAndName("a201", "홍길동");
		System.out.println("query4 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query5")
	public String query5() {
		List<User1VO> users = repo.findUser1VOByUidOrName("a201", "홍길동");
	...
	public String query9() {
		List<User1VO> users = repo.findUser1VOByAgeLessThanEqual(30);
		System.out.println("query9 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query10")
	public String query10() {
		List<User1VO> users = repo.findUser1VOByNameLike("%동%");
	...
	public String query12() {
		List<User1VO> users = repo.findUser1VOByNameStartsWith("홍길");
	...
	public String query17() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanOrderByAgeDesc(29);
		System.out.println("query17 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query18")
	public String query18() {
		int res = repo.countUser1VOByUid("a201");
		System.out.println("query18 결과 : "+res);
		return "redirect:/";
	}
	@GetMapping("/query19")
	public String query19() {
		int res = repo.countUser1VOByName("홍길동");
		System.out.println("query19 결과 : "+res);
		return "redirect:/";
	}
	@GetMapping("/query20")
	public String query20() {
		List<User1VO> users = repo.selectUser1UnderAge30();
		System.out.println("query20 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query21")
	public String query21() {
		List<User1VO> users = repo.selectUser1ByName("홍길동");
		System.out.println("query21 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query22")
	public String query22() {
		List<User1VO> users = repo.selectUser1ByWithParam("홍길동");
